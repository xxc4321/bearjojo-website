---
name: html-ppt
description: HTML PPT Studio — author professional static HTML presentations. Shared assets are located at D:\TRAE\html-ppt-shared\html-ppt-skill-main. Invoke when the user asks for a presentation, PPT, slides, keynote, deck, or slideshow.
---

# html-ppt — HTML PPT Studio

**CRITICAL: Shared assets for this skill are located at `D:\TRAE\html-ppt-shared\html-ppt-skill-main`.**
When generating or referencing assets (CSS/JS/Templates), always use paths relative to this shared directory or copy specific files to the project as needed.
